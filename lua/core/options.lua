...
vim.o.relativenumber = false -- Set relative number lines (default: false)
...
vim.o.shiftwidth = 4		-- The number of spaces inserted for each indentication (default: 8)
...
vim.o.smartindent = true -- Make indenting smarter again (default: false)
vim.o.showtabline = 2 -- Always show tabs (default: 1)
>>>>>>> 8a0f6ef (Implement three different colorthemes, incl. https://dotfyle.com/plugins/navarasu/onedark.nvim)
